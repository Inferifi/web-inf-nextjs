...
import { Bloom, DepthOfField, EffectComposer, N8AO, Noise, Pixelation, ToneMapping, Vignette } from '@react-three/postprocessing'
...
export default function App() {
    ...
    return (
        <>
            ...
            <div
                className="absolute left-0 top-0 h-screen w-full overflow-auto"
                ref={scrollArea}
                onScroll={onScroll}
